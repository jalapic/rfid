...
```{r}
## create a df with mouse, cohort, zone, time in zone, day
## or zone entries instead of time across each day
library(libridate)
c1.act$day <- 0

c1.act <- c1.act %>%
  ifelse(date = "09.27.2021", c1.act$day == 1,0)

dat <- c("02/01/2000", "20/02/2000", "12/12/2000", "13/01/2001")
dat <- dmy(dat)
